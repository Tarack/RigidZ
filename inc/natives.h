...
namespace PLAYER
{
	...
	static BOOL GIVE_ACHIEVEMENT_TO_PLAYER(int id) { return invoke<BOOL>(0xBEC7076D64130195, id); } // 0xBEC7076D64130195 0x822BC992
...
namespace CAM
{
	...
	static void _SET_FP_CAM_PITCH_RANGE(float minAngle, float maxAngle) { invoke<Void>(0xBCFC632DB7673BF0, minAngle, maxAngle); } // 0xBCFC632DB7673BF0 0x76DAC96C
	static void _SET_FP_CAM_NEAR_CLIP(float distance) { invoke<Void>(0x0AF7B437918103B3, distance); } // 0x0AF7B437918103B3 0x0E21069D
	static void _SET_AIM_CAM_NEAR_CLIP(float distance) { invoke<Void>(0x42156508606DE65E, distance); } // 0x42156508606DE65E 0x71E9C63E
...
namespace STREAMING
{
	...
	static void LOAD_SCENE(Any* x, float X, float Y) { invoke<Void>(0x4448EB75B4904BDB, x, X, Y); } // 0x4448EB75B4904BDB 0xB72403F5
...
{
	static int START_SHAPE_TEST_LOS_PROBE(float x1, float y1, float z1, float x2, float y2, float z2, int flags, Entity z3, int p8) { return invoke<int>(0x7EE9F5D83DD4F90E, x1, y1, z1, x2, y2, z2, flags, z3, p8); } // 0x7EE9F5D83DD4F90E 0xEFAF4BA6
